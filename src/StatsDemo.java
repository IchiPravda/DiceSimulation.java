...
public class StatsDemo
{
   ...
   public static void main(String[] args) throws IOException
   {
      ...
      /* Create a FileWriter object passing it the filename Results.txt (Don’t*/
      ...
      mean = sum/count;
      System.out.println("mean: "+mean+", Deviation " + stdDev);
...
in difference*/
      ...
      System.out.println("Standar Deviations: " + stdDev);
